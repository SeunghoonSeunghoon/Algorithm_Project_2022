...
void enQueue(Queue* q, element item)
{
    ...
    if (isFull(q))
        printf("------------------------------\n\n앉을 수 있는 테이블이 없으므로, 손님에게 퇴장 요청을 보냈습니다.\n\n------------------------------\n\n\n");
    else {
        cout << "--------------------\n\n손님을 추가했습니다.\n\n--------------------" << endl << endl << endl;
        q->rear++;
...
int main() {
    ...
    while (1) {
        cout << "     == 원하는 기능을 선택해 주세요 ==      " << endl << "---------------------- " << endl << endl << "1. 테이블 보기" << endl << "2. 손님 추가" << endl << "3. 손님 삭제" << endl << "4. 음식 할인율 열람" << endl << "5. 프로그램 종료" << endl << endl << "----------------------" << endl;
        cin >> ma_num;
        switch (ma_num) {
        case 1: 
            system("cls");
            cout  << endl << endl << "-------------------- " << endl << endl << "총 " <<  q.cnt  << "개의 테이블이 사용되고 있습니다." <<  endl << endl << "--------------------";
                break;
